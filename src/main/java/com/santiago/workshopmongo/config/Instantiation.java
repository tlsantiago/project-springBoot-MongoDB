...
public class Instantiation implements CommandLineRunner {
    ...
    public void run(String... arg0) throws Exception {
       ...
       Post post1 = new Post(null, sdf.parse("21/03/2020"), "Partiu viagem!", "Vou viajar para Dublin. Abraços!", maria);
       Post post2 = new Post(null, sdf.parse("23/03/2020"), "Bom dia!", "Um ótimo dia para estudar!", maria);
